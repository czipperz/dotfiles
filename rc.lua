...
beautiful.init(awful.util.getdir("config") .. "/themes/transBlack/theme.lua")
...
globalkeys = awful.util.table.join(
	...
	awful.key({ modkey, "Control" }, "e",     function () awful.util.spawn("emacsclient -c -a emacs") end),
    awful.key({ modkey, "Control" }, "r",     awesome.restart),
    awful.key({ modkey, "Control" }, "q",     awesome.quit),

    awful.key({ modkey,           }, right,   function () awful.tag.incmwfact( 0.049)    end),
    awful.key({ modkey,           }, left,    function () awful.tag.incmwfact(-0.049)    end),
